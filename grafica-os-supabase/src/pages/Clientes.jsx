...
function Modal({ open, onClose, onSave, initial }) {
  ...
  const setMasked = (k, mask, v) => set(k, mask(v));
          ...
          <div className="form-row-2">
            ...
            <div className="form-group">
              ...
              <input
                ...
                value={form.cpf_cnpj}
                onChange={e => setMasked('cpf_cnpj', maskCpfCnpj, e.target.value)}
          ...
          <div className="form-row-3">
            ...
            <div className="form-group">
              ...
              <input
                className="form-control"
                value={form.telefone}
                onChange={e => setMasked('telefone', maskPhone, e.target.value)}
            ...
            <div className="form-group">
              ...
              <input
                className="form-control"
                value={form.celular}
                onChange={e => setMasked('celular', maskPhone, e.target.value)}
          ...
          <div className="form-row-2">
            <div className="form-group">
              ...
              <input
                className="form-control"
                value={form.cep}
                onChange={e => setMasked('cep', maskCep, e.target.value)}
